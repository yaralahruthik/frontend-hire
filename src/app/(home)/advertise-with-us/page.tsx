      ...
      <section className="flex flex-col gap-6">
        ...
        <div className="mt-6 flex flex-col gap-4">
          ...
          <iframe
            ...
            src="https://plausible.iamyhr.com/share/frontendhire.com?auth=V7OaDJpzvKXi579sLJf6v&embed=true&theme=system"
            loading="lazy"
            style={{
              width: '1px',
              minWidth: '100%',
          ...
          ></iframe>
          <Script async src="https://plausible.iamyhr.com/js/embed.host.js" />
        </div>
        ...
        <Callout type="error" title="Analytics Not Loading?">
          <p>
            ...
            <Link
              target="_blank"
              className="underline underline-offset-2"
              href="https://plausible.iamyhr.com/frontendhire.com/"
            >
